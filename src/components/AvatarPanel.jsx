        ...
        >
          ...
          {!videoReady && !avatarError && (
            <div className={styles.placeholder}>
              ...
              <p className={styles.placeholderText}>곳간이 불러오는 중…</p>
              <p className={styles.placeholderSub}>3D 모델이 커서 첫 로드는 몇 초 걸릴 수 있어요.</p>
            </div>
          )}
          ...
          {!videoReady && avatarError && (
            <div className={styles.placeholder}>
              ...
              <p className={styles.placeholderText}>👋 곳간이가 비어있어요</p>
              <p className={styles.placeholderSub}>
                <code>public/model.glb</code> 파일을 추가하면 여기에 곳간이가 나타납니다.
              </p>
            </div>
          )}
          ...
          {videoReady && (
            <div className={styles.nameplate}>
              <div className={styles.nameplateInner}>
                <span className={styles.nameplateName}>곳간이</span>
                <span className={styles.nameplateSub}>AI 소비 대리인</span>
              </div>
            </div>
          )}
